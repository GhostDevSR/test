  ...
  return (
    <>
      ...
      <div style={{ maxWidth:940, margin:'0 auto', padding:'0 28px 80px' }}>
        ...
        <div id="samenvatting"><Section num="1" title="Samenvatting">
          <Card>
            <p style={{ fontSize:15, lineHeight:1.9, marginBottom:16 }}>
              Mijn naam is Albert Robijn en ik ben bezig met het opzetten van ShieldFlare, een cyberbeveiligingsbedrijf dat ik volledig zelf heb gebouwd. ShieldFlare biedt DDoS-bescherming, een reverse proxy, gameserver-bescherming en meer — allemaal binnen één platform, voor een prijs die ook kleine bedrijven en hobbyisten kunnen betalen.
            </p>
            <p style={{ fontSize:15, lineHeight:1.9, marginBottom:16 }}>
              Ik heb alles zelf ontwikkeld: van de backend en het dashboard tot de DNS-server, de WireGuard-integratie voor IP Guard, de WAF-proxy en een Discord bot. Het platform is technisch volledig operationeel en bevindt zich momenteel in de afrondende fase voor de officiële lancering. Klanten kunnen straks kiezen uit vier abonnementen, van gratis tot €80 per maand.
            </p>
            <p style={{ fontSize:15, lineHeight:1.9 }}>
              Wat ShieldFlare anders maakt dan Cloudflare is dat ik gameservers bescherm via TCP/UDP — iets wat Cloudflare niet biedt — en dat klanten een eigen dedicated IP-adres kunnen krijgen via IP Guard. Het platform is volledig in het Engels, zodat ik zowel Nederlandse als internationale klanten kan bedienen. De startkosten blijven beheersbaar omdat het platform al gebouwd is.
            </p>
          </Card>
        </Section></div>
        ...
        {/* 9. Financieel */}
        <div id="financieel"><Section num="10" title="Financieel plan">
