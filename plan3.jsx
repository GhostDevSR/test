      ...
      <div style={{ maxWidth:940, margin:'0 auto', padding:'0 28px 80px' }}>
          ...
          <Card title="🏆 Wat doet ShieldFlare anders?" style={{ marginBottom:16 }}>
            ...
            <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(260px,1fr))', gap:14, marginBottom:16 }}>
              {[
                ...
                ['💰','Betaalbaar voor klein MKB','Met een gratis instapplan en abonnementen vanaf €15 per maand is ShieldFlare bereikbaar voor iedereen — van hobbyisten tot groeiende webshops.'],
              ].map(([icon, title, desc]) => (
        ...
        <div id="levensvatbaarheid"><Section num="7" title="Levensvatbaarheid & urenverantwoording">
          ...
          <Card title="✅ Levensvatbaarheid — conclusie" style={{ marginBottom:16 }}>
              ...
              <table style={{ width:'100%', borderCollapse:'collapse', fontSize:13 }}>
                ...
                <tbody>
                  {[
                    ...
                    ['Inkomstenbelasting','—','-€ 4.792','-€ 29.563'],
                    ['Netto na belasting','-€ 6.936','+€ 14.422','+€ 66.551'],
                    ['Privébehoefte (jaar)','-€ 3.840','-€ 3.840','-€ 3.840'],
                    ['Netto beschikbaar','-€ 10.776','+€ 10.582','+€ 62.711'],
            ...
            <p style={{ marginTop:10, fontSize:11, color:S.dim, fontStyle:'italic' }}>
              Het aanloopverlies in jaar 1 wordt gedekt door de gevraagde Bbz-financiering van €30.000. Vanaf jaar 2 is het bedrijf in staat zichzelf te bedruipen.
            </p>
          </Card>
        ...
        <div id="financieel"><Section num="11" title="Financieel plan">
          ...
          <Card title="💳 2. Financieringsbegroting & benodigd startkapitaal" style={{ marginBottom:16 }}>
            ...
            <div style={{ background:S.greenBg, border:`1px solid ${S.greenBorder}`, borderRadius:12, padding:18, marginBottom:18 }}>
              ...
              <div style={{ fontSize:30, fontWeight:900, color:S.greenLight }}>€ 30.000</div>
              <div style={{ fontSize:12, color:S.dim, marginTop:4 }}>
            ...
            <Table headers={['Financieringsbehoefte','Berekening','Bedrag']}>
              ...
              <Row label="Laptop (zakelijk)" sub="Professionele laptop excl. BTW — primaire werktool" value="€ 2.479" />
              <Row label="2x Beeldscherm" sub="Zakelijke monitoren excl. BTW — werkplek" value="€ 826" />
              <Row label="Werkkapitaalbuffer" sub="Liquiditeitsreserve voor jaar 1 en jaar 2" value="€ 12.400" />
              <Row label="Totale financieringsbehoefte" sub="" value="€ 30.000" highlight />
            </Table>

            <Table headers={['Financieringsbron','Bedrag']}>
              <Row label="Eigen vermogen" value="€ 0" />
              <Row label="Bbz-bedrijfskapitaal / startslening (aanvraag)" value="€ 30.000" />
              <Row label="Qredits / alternatief krediet" value="€ 0 — alternatief" />
              <Row label="Totale financiering" value="€ 30.000" highlight />
            </Table>

            <p style={{ marginTop:12, fontSize:12, color:S.dim }}>
              Het bedrag van €30.000 is een ondernemingsplan-begroting en geen garantie op toekenning.
            ...
            <div style={{ overflowX:'auto', WebkitOverflowScrolling:'touch' }}>
              <table style={{ width:'100%', minWidth:620, borderCollapse:'collapse', fontSize:13 }}>
                ...
                <tbody>
                  ...
                  <FinanceRow label="Winst na zelfstandigenaftrek" y1="—" y2="€15.464" y3="€92.364" />
                  <FinanceRow label="MKB-winstvrijstelling (13,31%)" y1="—" y2="-€2.059" y3="-€12.294" />
                  <FinanceRow label="Belastbaar inkomen" y1="—" y2="€13.405" y3="€80.070" green />
                  <FinanceRow label="IB schijf 1 (tot €38.883 → 35,75%)" y1="—" y2="-€4.792" y3="-€13.901" />
                  <FinanceRow label="IB schijf 2 (€38.883–€78.426 → 37,56%)" y1="—" y2="—" y3="—" />
                  <FinanceRow label="IB schijf 3 (boven €78.426 → 49,50%)" y1="—" y2="€0" y3="-€814" />
                  <FinanceRow label="Totale inkomstenbelasting" y1="—" y2="-€4.792" y3="-€29.563" />
                  <FinanceRow label="Netto-inkomen na belasting" y1="-€6.936" y2="€14.422" y3="€66.551" highlight />
                </tbody>
              </table>
            </div>
          ...
          <Card title="📊 4. Kwartaalplanning jaar 1" style={{ marginBottom:16 }}>
            ...
            <p style={{ marginTop:12, fontSize:12, color:S.dim }}>
              De financieringsbuffer van €30.000 is bedoeld om de aanloopverliezen op te vangen en voldoende
          ...
          <Card title="💻 Hardware-investering & verantwoording" style={{ marginBottom:16 }}>
            <p style={{ marginBottom:14, fontSize:13 }}>
              ShieldFlare is een technisch platform dat dagelijks intensief gebruik maakt van development-omgevingen, serverbeheer, netwerkconfiguratie en monitoring. Om dit professioneel en efficiënt te kunnen doen is betrouwbare en krachtige hardware noodzakelijk.
            </p>
            <div style={{ background:S.blueBg, border:`1px solid ${S.blueBorder}`, borderRadius:12, padding:16, marginBottom:16 }}>
              <div style={{ fontSize:13, fontWeight:700, color:S.blueLight, marginBottom:8 }}>🎯 Waarom zakelijke hardware noodzakelijk is</div>
              <div style={{ fontSize:13, color:S.dim, lineHeight:1.8 }}>
                Als eenpersoonsbedrijf in de cybersecurity ben ik volledig afhankelijk van mijn apparatuur. Het platform wordt dagelijks beheerd, onderhouden en doorontwikkeld. Een trage of onbetrouwbare laptop leidt direct tot downtime voor klanten, vertraging in de ontwikkeling en een slechtere dienstverlening. Twee beeldschermen zijn noodzakelijk om effectief te werken: één voor de code-editor en één voor de servermonitoring of het dashboard. Dit verhoogt de productiviteit aanzienlijk en is in de IT-sector standaard.
              </div>
            </div>
            <div style={{ overflowX:'auto', marginBottom:16 }}>
              <table style={{ width:'100%', borderCollapse:'collapse', fontSize:13 }}>
                <thead>
                  <tr>{['Apparaat','Omschrijving','Bedrag incl. BTW','Bedrag excl. BTW','BTW terug'].map(h => <th key={h} style={{ padding:'9px 14px', textAlign:'left', background:'rgba(37,99,235,0.08)', color:S.blueLight, fontSize:11, fontWeight:700 }}>{h}</th>)}</tr>
                </thead>
                <tbody>
                  {[
                    ['Laptop','Professionele zakelijke laptop — primaire werktool','€ 3.000','€ 2.479','€ 521'],
                    ['2x Beeldscherm','Zakelijke monitoren — productiviteit en monitoring','€ 1.000','€ 826','€ 174'],
                    ['Totaal','','€ 4.000','€ 3.305','€ 695'],
                  ].map(([device,desc,incl,excl,btw]) => (
                    <tr key={device}>
                      <td style={{ padding:'9px 14px', borderBottom:`1px solid ${S.border}`, fontWeight:600, color:S.text }}>{device}</td>
                      <td style={{ padding:'9px 14px', borderBottom:`1px solid ${S.border}`, color:S.dim, fontSize:12 }}>{desc}</td>
                      <td style={{ padding:'9px 14px', borderBottom:`1px solid ${S.border}`, color:S.dim }}>{incl}</td>
                      <td style={{ padding:'9px 14px', borderBottom:`1px solid ${S.border}`, fontWeight:600, color:S.text }}>{excl}</td>
                      <td style={{ padding:'9px 14px', borderBottom:`1px solid ${S.border}`, fontWeight:600, color:S.greenLight }}>{btw}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))', gap:12 }}>
              {[
                ['💶 BTW terugvordering','€ 695','Terug via BTW-aangifte Q1'],
                ['📊 Afschrijving','5 jaar','€ 661/jaar als kostenpost'],
                ['💰 Netto investering','€ 2.610','Na BTW-teruggave'],
              ].map(([label,value,sub]) => (
                <div key={label} style={{ background:S.surface, border:`1px solid ${S.border}`, borderRadius:10, padding:14, textAlign:'center' }}>
            ...
            <p style={{ marginTop:14, fontSize:12, color:S.dim }}>
              De hardware wordt zakelijk aangeschaft en volledig zakelijk gebruikt. De BTW van €695 wordt teruggevorderd via de eerste BTW-aangifte. De apparatuur wordt afgeschreven over 5 jaar (€661/jaar), wat als zakelijke kostenpost wordt opgevoerd. De netto investering na BTW-teruggave bedraagt circa €2.610 — dit is opgenomen in de Bbz-financieringsaanvraag van €30.000.
            </p>
          </Card>
        ...
        <div id="opschaling">
          ...
          <Card title="📑 6. Belastingdruk & netto-inkomen" style={{ marginBottom:16 }}>
            ...
            <div style={{ overflowX:'auto', marginBottom:16 }}>
              <table style={{ width:'100%', borderCollapse:'collapse', fontSize:13 }}>
                ...
                <tbody>
                  {[
                    ['Bedrijfsresultaat (winst)','-€6.936','+€19.214','+€96.114'],
                    ['Zelfstandigenaftrek (2026)','Geen (verlies)','-€3.750','-€3.750'],
                    ['MKB-winstvrijstelling (13,31%)','—','-€2.059','-€12.294'],
                    ['Belastbaar inkomen','—','€13.405','€80.070'],
                    ['IB schijf 1 (35,75%)','—','-€4.792','-€13.901'],
                    ['IB schijf 2 (37,56%)','—','€0','-€14.848'],
                    ['IB schijf 3 (49,50%)','—','€0','-€814'],
                    ['Totale inkomstenbelasting','—','-€4.792','-€29.563'],
                    ['Netto-inkomen na belasting','-€6.936','+€14.422','+€66.551'],
                    ['Privébehoefte (jaar)','-€3.840','-€3.840','-€3.840'],
                    ['Netto vrij beschikbaar','-€10.776','+€10.582','+€62.711'],
                  ].map(([label,y1,y2,y3]) => (
                    <tr key={label}>
                      <td style={{ padding:'9px 14px', borderBottom:`1px solid ${S.border}`, fontWeight:500, color:S.text }}>{label}</td>
                      <td style={{ padding:'9px 14px', borderBottom:`1px solid ${S.border}`, textAlign:'right', color: y1.startsWith('-') ? '#f87171' : y1.startsWith('+') ? S.greenLight : S.dim }}>{y1}</td>
          ...
          <Card title="💳 7. Eigen vermogen & terugbetaling Bbz-lening" style={{ marginBottom:16 }}>
            <p style={{ marginBottom:14, fontSize:13 }}>
              Ik start ShieldFlare zonder eigen vermogen. De gevraagde Bbz-financiering van €30.000 is een bedrijfskapitaallening die terugbetaald wordt zodra het bedrijf voldoende omzet genereert.
            </p>
            <div style={{ overflowX:'auto', marginBottom:16 }}>
              <table style={{ width:'100%', borderCollapse:'collapse', fontSize:13 }}>
                <thead>
            ...
            <div style={{ background:S.orangeBg, border:`1px solid ${S.orangeBorder}`, borderRadius:10, padding:14 }}>
              ...
              <div style={{ fontSize:12, color:S.dim, lineHeight:1.7 }}>
                In jaar 1 wordt geen aflossing betaald — dit is het uitsteljaar. Vanaf jaar 2 los ik de lening af in 10 jaar. Bij een lening van €30.000 over 10 jaar komt dit neer op circa €250 per maand (exclusief rente). In jaar 2 is het verwachte netto-inkomen na belasting circa €13.414, wat ruimschoots voldoende is voor de aflossing van €3.000 per jaar naast de privébehoefte van €3.840. De exacte aflossings- en rentevoorwaarden worden bepaald door de Bbz-verstrekker.
              </div>
            </div>
          </Card>
          ...
          <Card title="📉 8. Conservatief scenario — wat als de groei tegenvalt?" style={{ marginBottom:16 }}>
              ...
              <table style={{ width:'100%', borderCollapse:'collapse', fontSize:13 }}>
                ...
                <tbody>
                  {[
                    ...
                    ['Buffer Bbz-lening','€30.000','€30.000'],
                    ['Resterende buffer na jaar 1','€23.064','€18.814'],
            ...
            <div style={{ background:S.greenBg, border:`1px solid ${S.greenBorder}`, borderRadius:10, padding:14 }}>
              ...
              <div style={{ fontSize:12, color:S.dim, lineHeight:1.7 }}>
                Zelfs in het conservatieve scenario — waarbij ik in jaar 1 slechts 10 betalende klanten haal — blijft de Bbz-buffer voldoende om het bedrijf voort te zetten. De werkkapitaalbuffer van €30.000 is bewust groot genoeg om ook tegenvallende groei op te vangen. Dit geeft ShieldFlare de tijd om de klantenbasis organisch op te bouwen zonder financiële druk.
              </div>
            </div>
          </Card>
        ...
        <div style={{ marginBottom:64 }}>
          ...
          <div style={{ background:S.surface, border:`1px solid ${S.border}`, borderRadius:14, padding:28 }}>
            ...
            <p style={{ fontSize:15, lineHeight:1.9, marginBottom:16}}>
              Ik heb aangetoond dat het bedrijf al in jaar 2 winstgevend is met een resultaat van ruim €19.000. De privébehoefte is laag doordat ik thuis woon, de infrastructuur wordt gefaseerd opgebouwd, en de gevraagde Bbz-financiering van €30.000 biedt voldoende buffer voor het eerste aanloopjaar inclusief de benodigde hardwareinvestering. Vanaf jaar 3 verwacht ik een bedrijfsresultaat van ruim €96.000.
            </p>
            ...
            <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))', gap:14 }}>
              {[
                ...
                ['💰','€30.000','Gevraagde Bbz-financiering'],
                ['📈','Jaar 2','Verwacht break-even'],
                ['🎯','50 klanten','Break-even bereikt'],
                ['🚀','Jaar 3','+€66.551 netto na belasting'],
              ].map(([icon, label, sub]) => (
                <div key={label} style={{ background:'rgba(37,99,235,0.06)', border:`1px solid ${S.border}`, borderRadius:10, padding:16, textAlign:'center' }}>
